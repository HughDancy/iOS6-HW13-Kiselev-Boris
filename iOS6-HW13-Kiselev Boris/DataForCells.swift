...
let mainData = Data(image: [UIImage(named: "Gear"), UIImage(named: "Toggles"),
                            UIImage(named:    "Aa"), UIImage(named: "HomeScreen"),
                            UIImage(named: "UniversalControl"), UIImage(named: "Oboi"),
                            UIImage(named: "Siri"), UIImage(named: "FaceId"),
                            UIImage(named: "SOS"), UIImage(named: "NotificationOfContact"),
                            UIImage(named: "Battery"), UIImage(named: "Confidetial")],
...
let appStoreData = Data(image: [UIImage(named: "AppStore"), UIImage(named: "Wallet")], text: ["App Store", "Wallet и Apple Pay"], secondText: [nil, nil])

let basicsAppData = Data(image: [UIImage(named: "Passwords"), UIImage(named: "Post"),                                          UIImage(named: "Contacts"), UIImage(named: "Calendar"),                                       UIImage(named: "Notes"), UIImage(named: "Reminders"),                                         UIImage(named: "Dictaphone"), UIImage(named: "Phone"),                                        UIImage(named: "Message"), UIImage(named: "Facetime"),                                        UIImage(named: "Safari"), UIImage(named: "Stocks"),                                           UIImage(named: "Weather"), UIImage(named: "Translate"),                                       UIImage(named: "Maps"), UIImage(named: "Compass"),                                            UIImage(named: "TapeMeasure"), UIImage(named: "FastCommands"),                                UIImage(named: "Health")],
                         text: ["Пароли", "Почта", "Контакты", "Календарь", "Заметки", "Напоминания", "Диктофон", "Телефон", "Сообщения", "FaceTime", "Safari", "Акции", "Погода", "Перевод", "Карты", "Компас", "Рулетка", "Быстрые команды", "Здоровье",],
                         secondText: [nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil])

let basicsMultimediaAppData = Data(image: [UIImage(named: "Music"), UIImage(named: "TV"),                                        UIImage(named: "Photo"), UIImage(named: "Camera"),                                            UIImage(named: "Books"), UIImage(named: "Podcasts"),                                          UIImage(named: "GameCenter")],
                                   text: ["Музыка", "TV", "Фото", "Камера", "Книги", "Подкасты", "Game Center"],
                                   secondText: [nil, nil, nil, nil, nil, nil, nil])

let tvProvaiderData = Data(image: [UIImage(named: "TVProvaider")], text: ["Телепровайдер"], secondText: [nil])
